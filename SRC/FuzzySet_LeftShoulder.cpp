...
/* Contructor */
FuzzySet_LeftShoulder::FuzzySet_LeftShoulder(float peak, float LeftOffset, float RighOffset) :
	FuzzySet(((peak - LeftOffset) + peak) / 2), m_fPeakPoint(peak), m_fRightOffset(RighOffset), m_fLeftOffset(LeftOffset)
{}
